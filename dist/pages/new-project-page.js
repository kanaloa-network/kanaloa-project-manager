...
import { maxLengthPreprocessor } from '../components/forms';
import { GlobalKanaloaEthers } from '../api/kanaloa-ethers';
let NewProjectPage = class NewProjectPage extends LitElement {
    constructor() {
        super();
    ...
    async submitHandler(ev) {
        ...
        if (form.hasFeedbackFor.includes('error')) {
            const firstFormElWithError = form.formElements.find((el) => el.hasFeedbackFor.includes('error'));
