...
def run_nix_develop_shell(directory, command, env={}, output=subprocess.DEVNULL):
...
if __name__ == "__main__":
    ...
    deployment_script = "script/demo.s.sol:Demo"
    ...
    #demo_wallet = "0xB3a7abF1BC2840Be39544169e9f857bD9127BB6c"
    ...
    child_processes = [
        run_nix_develop_shell(kana_contracts_dir, "anvil", output=None),
        run_nix_develop_shell(
            ...
            { 
                "DEPLOYER_ADDRESS": deployment_sender,
                "DEMO_ADDRESS": demo_wallet
            }, 
            None
        ),
